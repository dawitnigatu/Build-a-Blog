...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://Build-a-Blog1:115526@localhost:8889/Build-a-Blog1'
...
def blog():
    ...
    if blog_id:
        ...
        if user_id:
            hgbentries = Blog.query.filter_by(owner_id=user_id).all()
